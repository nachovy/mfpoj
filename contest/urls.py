...
urlpatterns = [
    ...
    re_path(r'^contest/(?P<contest_id>[0-9]+)/submit/(?P<problem_id>[a-zA-Z0-9]+)/$', views.contest_submit, name='contest_submit'), 
    re_path(r'^contest/(?P<contest_id>[0-9]+)/problem/(?P<problem_id>[a-zA-Z0-9]+)/$', views.contest_problem, name='contest_problem'), 
